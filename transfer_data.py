        ...
        for lines in csvFile:
            if lines[1] == college_name:
                if lines[6] :
                    ...
                    print(college_name, "Tuition and fees are $",20000)
                break
        ...
        for lines in csvFile:
            if lines[1] == college_name:
                if lines[8] :
                    ...
                    print("Total price for out-of-state students living on campus at ",college_name, "is $",20000)
                break
        ...
        for lines in csvFile:
            if lines[1] == college_name:
                if lines[7] :
                    ...
                    print("Total price for in-state students living on campus at ",college_name, "is $",20000)
                break
        ...
        for lines in csvFile:
            if lines[1] == college_name:
                if lines[9]:
                    ...
                    print("Total price for in-state students living off campus (not with family) at ",college_name, "is $",20000)
                break
        ...
        for lines in csvFile:
                if lines[1] == college_name:
                    if lines[10]:
                        ...
                        print("Total price for out-of-state students living off campus (not with family) at ",college_name, "is $",20000)
                    break
        ...
        for lines in csvFile:
            if lines[1] == college_name:
                if lines[11]:
                    ...
                    print("Total price for in-state students living off campus (with family) at ",college_name, "is $",20000)
                break
        ...
        for lines in csvFile:
            if lines[1] == college_name:
                if lines[12]:
                    ...
                    print("Total price for out-of-state students living off campus (with family) at ",college_name, "is $",20000)
                break
...
#get_colleges_with_lower_tuition_than(15000)
